            ...
            if self.side == "1P":
                if scene_info["ball_speed"][1] > 0 :
                    ...
                    if scene_info["ball_speed"][0] > 0:
                        ...
                        direction = 3
                X = [scene_info["ball"][0], scene_info["ball"][1], direction, scene_info["blocker"][0],scene_info["ball_speed"][0],scene_info["ball_speed"][1],Frames,sceneInfo["platform_1P"],sceneInfo["platform_2P"][0]]
                ...
                if scene_info["ball_speed"][1] > 0 :
                    ...
                    if scene_info["ball_speed"][0] > 0:
                        ...
                        direction = 3
                X = [scene_info["ball"][0], scene_info["ball"][1], direction, scene_info["blocker"][0],scene_info["ball_speed"][0],scene_info["ball_speed"][1],,sceneInfo["platform_1P"],sceneInfo["platform_2P"][0]]
                X = np.array(X).reshape((1,-1))
                pred = self.model.predict(X)
